...
const BLOG = {
  ...
  TTHEME_SWITCH: process.env.NEXT_PUBLIC_THEME_SWITCH || false, // 是否显示切换主题按钮
  ...
  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || 'Xqd', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || '一个普通的大学生', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://notion-next-ashy-three.vercel.app/', // 网站地址
  KEYWORDS: process.env.NEXT_PUBLIC_KEYWORD || 'xqd, 博客', // 网站关键词 英文逗号隔开
